...
font=self.manage_font.heading_font) 
        ...
        measurement_system_label = tk.Label(bmi_frame, text="Select Measurement 
System:", font=self.manage_font.medium_bold_letters_font) 
    ...
    def calculate_bmi(self): 
        try: 
            ...
            if not self.weight_entry.get() and not self.height_entry.get(): 
                ...
                self.bmi_result_label.config(text="Please enter a numeric weight 
and height.") 
...
background="#333333") 
        ...
        bmi_educational_description = 
read_text.extract_description(description_title) 
